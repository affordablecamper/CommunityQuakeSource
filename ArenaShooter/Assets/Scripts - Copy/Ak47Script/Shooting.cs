   ...
   public AudioClip metalimpactSound;
    ...
    void Update()
    {
        ...
        if (isLocalPlayer)
        {
            ...
            if (fireCountdown >= 0f)
            {
                ...
                if (Input.GetKeyDown(KeyCode.R) && magAmmo != maxMagazineSize && reserveAmmo != 0 && isAiming == false)
                {
                    ...
                    if (magEmpty == true)
                    {
                        ...
                        akmReload.SetBool("isFullReload", true);
                        akmReload.SetBool("isShortReload", false);
    ...
    public void Shoot()
    {

        {
            ...
            if (Input.GetButton("Fire1") && magEmpty == false && audioPlay == true && isReloading == false)

            {
                    ...
                    if (Physics.Raycast(ray, out hitInfo, weaponRange, playerMask))
                {
                    ...
                    if (hitInfo.collider.tag == "Player")
                    {
                        ...
                        CmdPlayerShot(hitInfo.collider.name, weapon.AKDamage);
